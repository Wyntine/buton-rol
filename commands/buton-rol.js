...
module.exports = {
  ...
  run: async (client, interaction, message) => {
    ...
    if (rol.position >= rol.guild.members.me.roles.highest.position)
      return interaction.reply({ embeds: [pozisyon], ephemeral: true });
    ...
    if (input === "red") {
      ...
      db.set(`butonRol_${interaction.guild.id}`, rol.id);
      ...
      return interaction.channel
        .send({ embeds: [butonRolMesaj], components: [row] })
        .catch(() => {
